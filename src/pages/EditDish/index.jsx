...
export function EditDish() {
    ...
    async function handleUpdateDish() {
        if (!image) {
            return alert("Erro: Você não carregou a nova imagem do ingresso!");
        }
        ...
        await api
            ...
            .then(alert("Ingresso atualizado com sucesso!"), navigate("/"))
            .catch((error) => {
                if (error.response) {
                        ...
                        user.isAdmin ?
...

                            {
                                ...
                                <Form>
                                            ...
                                            <div className="dishName">
                                                ...
                                                <div className="dishCategory">
                                                    ...
                                                    <select value={category} onChange={e => setCategory(e.target.value)}>
                                                        ...
                                                        <option value="dishes">Teatro</option>
                                    ...
                                    <div className="textarea">
                                        <p>Descrição</p>
                                        <Textarea 
                                            placeholder="Fale brevemente sobre o ingresso, seus setores e tags"
                            ...
                            <div className="button">
                                <Button 
                                    ...
                                    title={loadingDelete ? "Excluindo ingresso" : "Excluir ingresso"}
